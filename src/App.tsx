...
const INSTAGRAM_POSTS: InstagramPost[] = [
  {
    ...
    caption:
      "Dimensional custom hand-painted vanilla honey balayage by Master Stylist Olivia. Absolute perfection! ✨ #AuraTransformed #BalayageArtists #YorkvilleHair",
    likes: 428,
    commentsCount: 18,
    ...
    comments: [
      {
        user: "serene_beauty",
        text: "Oh my gosh, this blending is absolute magic! 😍",
      },
      {
        user: "clara_t",
        text: "Olivia does it again, best salon in Toronto hands down!",
      },
    ],
  },
  {
    ...
    caption:
      "Aesthetic pastel organic shellac and gold-leaf details. Pure elegance in every single stroke. 💅🏼✨ #AuraNails #MinimalistMani #NailArtistry",
    likes: 312,
    commentsCount: 11,
    ...
    comments: [
      {
        user: "nailedit_xo",
        text: "The gold-leaf detail is so subtle and beautiful.",
      },
      {
        user: "justine_v",
        text: "Need to book this combination before my trip next weekend!",
      },
    ],
  },
  {
    ...
    caption:
      "Seamless drop skin fade and straight-razor cheek alignment by Marcus Dubois. Crisp, tailored lines. 💈🔥 #DapperStyle #BarberSculpt #MensHaircut",
    likes: 589,
    commentsCount: 24,
    ...
    comments: [
      {
        user: "dan_gilbert",
        text: "Sharpest fade in the city. Marcus is a legend.",
      },
  ...
  },
  {
    ...
    caption:
      "Infusing raw bioactive peptides and deep calming botanicals during our Hydrating Facial Cure treatment. Nourishment for active glow. 💆🏼‍♀️🌿 #AuraSkin #OrganicBeauty #FacialCure",
    likes: 247,
    commentsCount: 9,
    ...
    comments: [
      {
        user: "helena_clarke",
        text: "My skin felt completely brand new after this treatment!",
      },
      {
        user: "glow_with_me",
        text: "The organic cucumber mist is of another world.",
      },
    ],
  },
  {
    ...
    caption:
      "Bouncy multi-layered blowout with customized essential protein serums. High volume, incredible strength and shine. ✨👄 #AuraBlowout #ShinyHair #HealthyVolume",
    likes: 351,
    commentsCount: 14,
    location: "Aura Yorkville, Toronto",
    date: "3 days ago",
    ...
    comments: [
      {
        user: "fiona.mink",
        text: "How long does this blowout lasted? Looks stunning!",
      },
      {
        user: "aurasalon",
        text: "Up to 4-5 days with our signature styling memory spray! @fiona.mink",
      },
    ],
  },
  {
    ...
    caption:
      "Our botanically formulated nourishing line. Sustainable, clean, and clinical. Preserving your scalp's flora. 🌿🏷️ #AuraApothecary #ScalpHacks",
    likes: 194,
    commentsCount: 7,
    ...
    comments: [
      {
        user: "lucy_m",
        text: "The absolute best way to wind down a hectic week.",
      },
      {
        user: "organic_living",
        text: "Love that you use wild-harvested massage oils!",
      },
    ],
  },
];
...
const AURA_SPACES: AuraSpace[] = [
  {
    ...
    description:
      "Our quiet, low-lit chamber of complete relaxation. Features ergo-molded wash beds, bespoke warm thermal head vapor, scalp rebalancing botanicals, and a deep massage designed to quiet the mind before your cut begins.",
    image: luxurySalonWash,
  ...
  },
  {
    ...
    description:
      "Designed for ultimate optical precision. Custom neutral-color backlit day-lighting mirrors ensures that every razor fade, texturized perimeter, and weight-removal layering appears exactly as it will in true daylight.",
    image: luxuryStylingChair,
    badge: "Chairs Grid",
  ...
  },
  {
    ...
    description:
      "A clinical skin rejuvenation room showcasing local ingredients. We infuse fresh micro-milled cucumber hydrosols, organic honey masks, and high-purity peptides to restore and balance your natural dermal barrier.",
    image:
  ...
  },
  {
    ...
    description:
      "Our master painters design dimensional light. Here, custom hair paints, platinum transformations, and multi-tonal chocolate overlays are meticulously woven with organic styling bond protectors to guard your fiber's health.",
    image: stylingBalayageFoils,
        ...
        {currentTab === "home" && (
          <div className="flex flex-col">
            ...
            <div className="bg-primary py-4.5 border-y border-accent/20 overflow-hidden select-none whitespace-nowrap flex relative z-10">
              ...
              <div
                className="flex gap-16 text-[10px] font-mono tracking-[0.3em] text-accent uppercase font-bold animate-marquee shrink-0"
                aria-hidden="true"
              >
                <span>✦ BESPOKE SCISSOR CUTS</span>
                <span>✦ HAND-PAINTED BALAYAGE</span>
            ...
            <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <AnimatedSection
                  direction="left"
                  className="lg:col-span-5 flex flex-col justify-center min-h-[460px]"
                >
                      ...
                      const activeSpaceId =
                        hoveredSpaceId !== null
                          ...
                          : lockedSpaceId !== null
                            ...
                            : 1;
                      const activeSpace =
                        AURA_SPACES.find((s) => s.id === activeSpaceId) ||
                        AURA_SPACES[0];
                        ...
                        >
                          ...
                          <div className="bg-[#FAF7F2] border border-accent/20 p-5 rounded-[18px] space-y-4 mt-2">
                            <div className="flex items-center justify-between text-[10px] font-mono">
                              <span className="text-text-muted tracking-wider uppercase">
                                Signature Standard:
                              </span>
                          ...
                          <div className="flex items-center justify-between pt-2 border-t border-accent/10">
                            <span className="text-[10px] font-mono text-text-muted">
                              Tap any lounge grid quadrant to tour
                            </span>
                            <button
            ...
            <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-border-custom">
              <div className="text-center mb-12">
                ...
                <p className="text-xs text-text-muted mt-3 font-light">
                  ...
                  to explore real transformations, hair hacks, and special
                  weekly offers.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                {INSTAGRAM_POSTS.map((post, id) => (
                  ...
                  >
                    <div
                      onClick={() => setSelectedInstagramPost(post)}
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-primary/85 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center justify-center text-secondary p-4 gap-3">
                        <div className="flex items-center gap-6">
                          ...
                          <span className="flex items-center gap-1.5 font-mono text-sm text-[#FAF7F2] font-medium">
                            <MessageSquare className="w-4 h-4 text-[#FAF7F2] fill-transparent" />{" "}
                            {post.commentsCount}
                          </span>
                        </div>
                        <span className="text-[10px] font-mono tracking-[0.2em] text-[#FAF7F2]/80 uppercase font-bold">
                          @AURASALONCANADA
                        </span>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-[10px] font-mono text-accent font-semibold uppercase">
                                Follow
                              </span>
                            </div>
                            <span className="text-[10px] text-text-muted block font-light">
                              Toronto Yorkville Elite Lounge
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3 pt-2">
                          ...
                          <div className="space-y-2 max-h-[140px] overflow-y-auto no-scrollbar">
                            {selectedInstagramPost.comments.map(
                              (comment, cid) => (
                                <div
                                  key={cid}
                                  className="text-xs leading-normal bg-[#FAF7F2] p-2 rounded-lg border border-accent/10"
                                >
                                  <span className="font-mono font-bold mr-1.5 text-[10px] tracking-wider text-primary">
                                    @{comment.user}
                                  </span>
                                  <span className="text-text-muted font-light text-[11px]">
                                    {comment.text}
                                  </span>
                                </div>
                              ),
                        ...
                        <div className="flex items-center justify-between text-xs">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="font-mono font-bold">
                              {selectedInstagramPost.likes}{" "}
                              <span className="font-sans font-light text-text-muted">
                                likes
                              </span>
                            </span>
                          </div>
                          <span className="text-[10px] text-text-muted font-mono tracking-wider">
                            {selectedInstagramPost.date}
                          </span>
                        </div>
