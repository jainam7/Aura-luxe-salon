...
export default function ContactView() {
  ...
  return (
    <div id="contact_and_faqs" className="bg-surface text-primary select-none pb-12">
      ...
      <section className="relative h-[250px] w-full bg-[#1A1A1A] overflow-hidden border-b border-accent/20">
        ...
        <div className="absolute bottom-6 left-6 right-6 max-w-7xl mx-auto flex items-end justify-between">
          <div>
            <span className="text-[10px] font-mono tracking-wider text-accent uppercase font-bold">TORONTO STUDIO LOCATION OFFICE</span>
            <h2 className="font-serif text-2xl text-secondary font-light mt-0.5 uppercase tracking-wider">AURA HQ & ATELIER</h2>
          </div>
          <span className="hidden sm:inline-block text-[10px] font-mono text-accent/60">© 2016 Toronto Canada</span>
        </div>
      </section>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 border-b border-border-custom">
        ...
        <div className="lg:col-span-7 bg-secondary/30 border border-border-custom rounded-[20px] p-6 sm:p-8">
          <span className="text-[10px] font-mono tracking-widest text-accent uppercase font-bold">CORE COMMUNICATIONS</span>
          <h3 className="font-serif text-2xl sm:text-3xl text-primary font-light mt-1.5 mb-1">Send an Online Inquest</h3>
          <p className="text-text-muted text-xs font-light mb-6">Our concierge responses are finalized bilingual within 4 business hours.</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Name */}
              <div>
                <label className="block text-[10px] font-mono uppercase tracking-wider text-text-muted mb-1">Your Full Name *</label>
                <input
                  type="text"
                  required
                  value={contactName}
              ...
              {/* Email */}
              <div>
                <label className="block text-[10px] font-mono uppercase tracking-wider text-text-muted mb-1">Email Address *</label>
                <input
                  type="email"
                  required
                  value={contactEmail}
            ...
            {/* Subject */}
            <div>
              <label className="block text-[10px] font-mono uppercase tracking-wider text-text-muted mb-1">Subject Option</label>
              <select
              ...
              >
                ...
                <option value="Bridal Packages Quote">Bridal Packages Quote</option>
                <option value="Product Sourcing Care">Product Sourcing Care</option>
                <option value="Career Opportunities">Career Opportunities</option>
                <option value="Franchise Operations">Franchise & Partner Options</option>
              </select>
            </div>

            {/* Message Area */}
            <div>
              <label className="block text-[10px] font-mono uppercase tracking-wider text-text-muted mb-1">Your Message Brief *</label>
              <textarea
                rows={5}
                required
            ...
            {showSuccessMsg && (
              <div className="p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-lg text-emerald-600 text-xs font-mono flex items-center gap-2.5">
                ...
                <span>Message submitted! Toronto Coordinates concierge desk will resolve to you shortly.</span>
              </div>
            )}
        ...
        <div className="lg:col-span-5 flex flex-col gap-8 justify-between">
          <div className="flex flex-col gap-6">
            <span className="text-[10px] font-mono tracking-widest text-accent uppercase font-bold">CONTACT DIRECTORY</span>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-serif text-[15px] font-semibold text-primary leading-tight">Toronto Concierge HQ</h4>
                <p className="text-text-muted text-xs font-light leading-relaxed mt-1">
                  123 Main Street, Suite 101<br />
                  Toronto, ON M5V 2T6, Canada
                </p>
                <span className="text-[10px] font-mono text-accent/60 tracking-wider">Suite is wheel-chair accessible.</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-serif text-[15px] font-semibold text-primary leading-tight">Telephone Desk</h4>
                <p className="text-text-muted text-xs font-light leading-relaxed mt-1">
                  +1 (416) 555-0198
                </p>
                <span className="text-[10px] font-mono text-accent/60 tracking-wider">Direct support in English & French.</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-serif text-[15px] font-semibold text-primary leading-tight">Email Delivery</h4>
                <p className="text-text-muted text-xs font-light leading-relaxed mt-1">
                  hello@aurasalon.ca
                </p>
              </div>
          ...
          {SALONS_FAQS.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Answer content */}
                {isOpen && (
                  <div className="px-5 pb-5 pt-1 border-t border-white/5 text-xs text-text-muted leading-relaxed font-light font-sans">
                    {faq.a}
                  </div>
                )}
              </div>
